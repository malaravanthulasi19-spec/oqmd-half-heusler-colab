...
def compute_material_selection_scores(row: dict) -> dict:
    ...
    for k,w in [("has_thermoelectric_context",15),("has_half_metal_context",20),("has_ferromagnetic_context",15),("has_spintronic_context",10),("has_dft_context",10),("has_phonon_context",10),("has_mechanical_stability_context",10),("has_stability_context",10),("has_keypaper_thermoelectric_context",12),("has_keypaper_magnetic_spintronic_context",12),("has_keypaper_phonon_context",8),("has_keypaper_mechanical_context",8),("has_keypaper_electronic_context",8)]:
    ...
    lit_pen += 70 if keypaper_depth >= 80 else 35 if keypaper_depth >= 60 else 0
